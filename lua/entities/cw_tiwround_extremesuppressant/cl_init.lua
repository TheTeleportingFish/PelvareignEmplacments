...
function ENT:Initialize()
	...
	net.Receive( "Client_Shockwave_Round", function( len )
		...
		timer.Simple( ContinationWave , function() 
			EmitSound( "main/caplier_faucation.wav" , Vector() , -1 , CHAN_AUTO , math.Clamp(Dist^2,0,1) , 90 , 0 , math.random(150,180) )
			EmitSound( "main/radeonic_distresipution_wave_"..math.random(1,7)..".wav" , Vector() , -1 , CHAN_AUTO , math.Clamp(Dist^0.25,0,0.8) , 90 , 0 , math.random(100,110) )
		end)
	end)
	...
	net.Receive( "Client_Shockwave_PressurizedExplosive", function( len )
		...
		timer.Simple( ContinationWave , function() 
			EmitSound( "main/tacklecatics_endshock.wav" , Vector() , -1 , CHAN_AUTO , math.Clamp(Dist^1.5,0,1) , 130 , 0 , math.random(76,80) )
			EmitSound( "main/caplier_faucation.wav" , Vector() , -1 , CHAN_AUTO , math.Clamp(Dist^0.6,0,1) , 130 , 0 , math.random(90,110) )
			EmitSound( "main/tacklecatics_beginshock.wav" , Vector() , -1 , CHAN_AUTO , math.Clamp(Dist^10,0,1) , 130 , 0 , math.random(60,65) )
		end)
	end)
