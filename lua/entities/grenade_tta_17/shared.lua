...
function ENT:FindTarget()
	...
	for key,found in pairs(EntInSphere)do
		...
		if ( (IsValid(Phys) and found ~= self) or IsValid(string.match(type(found),"NPC")) ) and Class ~= "caterous_fragmentation" and Class ~= "mine_esbmfrag" and not found:IsPlayer() then --or found:IsPlayer()
...
function ENT:FindDmgTarget()
	...
	for key,found in pairs(EntInSphere)do
		local Phys=found:GetPhysicsObject()
		local Class=found:GetClass()
		if ( (IsValid(Phys) and found ~= self) or IsValid(string.match(type(found),"NPC")) ) and Class ~= "caterous_fragmentation" and Class ~= "mine_esbmfrag" then --or found:IsPlayer()
...
function ENT:Think()
	...
	local ModelMinBound , ModelMaxBound = self:GetModelBounds()
