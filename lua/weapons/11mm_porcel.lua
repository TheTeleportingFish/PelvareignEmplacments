...
SWEP.PrintName			= "11mm Cabre Porcel" -- This will be shown in the spawn menu, and in the weapon selection menu
...
SWEP.RoundTypes = 
{
	Regular = { Type = "cw_11mmporcelround" , Speed = 800 },
...
function SWEP:PrimaryAttack()
	...
	if ( self.Weapon:Clip1() <= 0 ) then
		...
		owner:SetVelocity( -owner:GetAimVector() * 10 )
